...
some other ruleset that depends on rules_bun, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_bun=$(pwd)/rules_bun"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_bun` on your system will point to this folder.
...
https://github.com/levonk/rules_bun/actions/workflows/tag.yaml
