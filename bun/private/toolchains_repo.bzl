...
# By default all these toolchains are registered by the bun_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:bun_toolchain",
    toolchain_type = "@levonk_rules_bun//bun:toolchain_type",
)
""".format(
            platform = platform,
